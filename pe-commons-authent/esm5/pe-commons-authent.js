...
var AuthorizationCodeFlow = (function () {
    function AuthorizationCodeFlow(http, openAMOptions, state, redirect_uri) {
        this.http = http;
...
var AuthorizationCodeWithPKCEFlow = (function () {
    function AuthorizationCodeWithPKCEFlow(http, openAMOptions, state, redirect_uri, verifier) {
        this.http = http;
        this._options = openAMOptions;
        this._redirect_uri = redirect_uri;
        this._state = state;
...
var OpenAMType = (function () {
    function OpenAMType(openAMOptions, mode, redirect, http) {
    ...
    OpenAMType.prototype.logout = function (token, callback) {
        ...
        if (token !== null) {
            ...
            var oidcParams = new HttpParams().set('id_token_hint', token['id_token']);
...
var PeAuthTypeFactory = (function () {
    function PeAuthTypeFactory(options, http, locationStrategy) {
        this.http = http;
...
var PeAuthGuardService = (function () {
    function PeAuthGuardService(router, peAuthService, peInterceptService) {
        var _this = this;
        this.router = router;
...
var PeAuthInterceptor = (function () {
    function PeAuthInterceptor(injector, router, peAuthGuardService) {
        var _this = this;
        ...
        this.peAuthService.getStatus().subscribe(function (subject) {
            ...
            if (_this.connexionInProgress && _this.waitingToken === null) {
                _this.waitingToken = new Subject();
            }
...
var PeAuthComponent = (function () {
    function PeAuthComponent(router, peAuthService, peInterceptService, element) {
        this.router = router;
        this.peAuthService = peAuthService;
        this.peInterceptService = peInterceptService;
